                            ...
                            for (int k = 0; k < GameManager.instance.equipmentSlots.Length; k++)
                            {
                                if (k < GameManager.instance.equipmentItems.Count)
                                {
                                    if (GameManager.instance.equipmentHelmets[j].itemName == GameManager.instance.equipmentItems[k].itemName)
                                    {
                                        ...
                                        GameManager.instance.equipmentItems[k].eUsing = false;
                                    }
        ...
        else if (GetThisEItem().EquipmentID == 2)
        {
            ...
            for (int i = 0; i < GameManager.instance.equipmentItems.Count; i++)
            {
                if (GameManager.instance.equipmentItems[i].EquipmentID == 2 && GameManager.instance.equipmentItems[i].itemName == eItem.itemName)
                {
                    ...
                    {
                        if (!(GameManager.instance.equipmentChest[j].itemName == eItem.itemName) && GameManager.instance.equipmentChest[j].eItemUsedByCharacter == eItem.eItemUsedByCharacter)
                        {
        ...
        else if (GetThisEItem().EquipmentID == 3)
        {
            ...
            for (int i = 0; i < GameManager.instance.equipmentItems.Count; i++)
            {
                if (GameManager.instance.equipmentItems[i].EquipmentID == 3 && GameManager.instance.equipmentItems[i].itemName == eItem.itemName)
                {
                    ...
                    {
                        if (!(GameManager.instance.equipmentPants[j].itemName == eItem.itemName) && GameManager.instance.equipmentPants[j].eItemUsedByCharacter == eItem.eItemUsedByCharacter)
                        {
        ...
        else if (GetThisEItem().EquipmentID == 4)
        {
            ...
            for (int i = 0; i < GameManager.instance.equipmentItems.Count; i++)
            {
                if (GameManager.instance.equipmentItems[i].EquipmentID == 4 && GameManager.instance.equipmentItems[i].itemName == eItem.itemName)
                {
                    ...
                    {
                        if (!(GameManager.instance.equipmentBoots[j].itemName == eItem.itemName) && GameManager.instance.equipmentBoots[j].eItemUsedByCharacter == eItem.eItemUsedByCharacter)
                        {
        ...
        else if (GetThisEItem().EquipmentID == 5)
        {
            ...
            for (int i = 0; i < GameManager.instance.equipmentItems.Count; i++)
            {
                if (GameManager.instance.equipmentItems[i].EquipmentID == 5 && GameManager.instance.equipmentItems[i].itemName == eItem.itemName)
                {
                    ...
                    if (GameManager.instance.playerC.GetComponent<CharacterSwapping>().currentCharacter.GetComponent<PlayerDetectShoot>().bulletShoot1 == null)
                    {
                        GameManager.instance.playerC.GetComponent<CharacterSwapping>().currentCharacter.GetComponent<PlayerDetectShoot>().bulletShootDamage1 += GetThisEItem().value;
                    ...
                    {
                        GameManager.instance.playerC.GetComponent<CharacterSwapping>().currentCharacter.GetComponent<PlayerDetectShoot>().bulletShootDamage2 += GetThisEItem().value;
